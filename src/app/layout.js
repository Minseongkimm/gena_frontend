        ...
        <div className="min-h-screen flex flex-col md:flex-row bg-[#f6f8fb]">
          <aside className="w-full md:w-64 bg-white border-r border-gray-200 flex-shrink-0 flex flex-col">
            ...
            className="flex items-center gap-3 px-6 py-6 ">
              <div className="w-10 h-10 bg-gradient-to-tr from-blue-500 to-cyan-400 rounded-lg flex items-center justify-center shadow">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3 3v18h18M9 17V9m4 8V5m4 12v-6" />
                </svg>
              </div>
              <div>
                <div className="font-bold text-lg text-gray-900">Gena AI</div>
                <div className="text-xs text-gray-400">Dashboard, Charts</div>
              </div>
            </a>
